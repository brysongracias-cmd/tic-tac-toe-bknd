# Generate a Word document describing the generated project and test results.
import os
...
output_dir = r"/home/himanshu.jangra/backendX/backend/outputs/93882a75-762a-45f3-a2b2-f23fdc62ca0d"

skip_dirs = [".venv", "venv", "__pycache__", ".git", "node_modules", ".code_index", ".pytest_cache"]
generated_files = []
